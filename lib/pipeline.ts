...
export const PIPELINE_STEPS: PipelineStepTemplate[] = [
  ...
  {
    order: 4,
    actionKey: "unplug_downlink_sw1",
    label: "Unplug Downlinks",
    team: "B",
    phase: "SW1",
  },
  { order: 5, actionKey: "decomm_sw1", label: "Decommission", team: "A", phase: "SW1" },
  {
    order: 6,
  ...
  { order: 8, actionKey: "downlink_sw1", label: "Plugin Downlinks", team: "B", phase: "SW1" },
  { order: 9, actionKey: "post_check_sw1", label: "Post Check", team: "A", phase: "SW1" },
  { order: 10, actionKey: "label_sw2", label: "Label", team: "B", phase: "SW2" },
  {
    order: 11,
    actionKey: "unplug_downlink_sw2",
    label: "Unplug Downlinks",
    team: "B",
    phase: "SW2",
  },
  { order: 12, actionKey: "decomm_sw2", label: "Decommission", team: "A", phase: "SW2" },
  {
    order: 13,
  ...
  { order: 15, actionKey: "downlink_sw2", label: "Plugin Downlinks", team: "B", phase: "SW2" },
  { order: 16, actionKey: "post_check_sw2", label: "Post Check", team: "A", phase: "SW2" },
];
